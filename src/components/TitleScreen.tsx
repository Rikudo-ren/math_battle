...
import { DIFF_INFO, MODE_INFO, MODE_ORDER, type Difficulty, type ProblemMode } from "../lib/problems";
...
export default function TitleScreen({ onStart, best, audioReady, lightweight, onEnableAudio }: Props) {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-5 py-5">
        <div className="absolute inset-x-0 top-0 flex items-center justify-between px-5 py-3 font-mono2 text-[10px] tracking-[0.3em] text-cyan-300/60">
          <span>SYS://NUMERIC_VELOCITY.EXE</span>
          <span className="flex items-center gap-3">
            <span className="pulse-soft">ONLINE</span>
            {!audioReady && <span className="text-mag-neon">AUDIO STANDBY</span>}
          </span>
        </div>
